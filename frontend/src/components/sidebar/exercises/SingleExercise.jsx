...
export default function SingleExercise({ data, exercise, setShowArticle, id }) {
    ...
    const [exercise_subject, setExerciseSubject] = useState("Introduction to Biology");
            ...
            <button onClick={() => setShowEdit(!showEdit)}>Edit</button>
            {
                showEdit && (
                    <form>
                        ...
                        <select className="select-element my-5" value={exercise_subject} onChange={(e) => setExerciseSubject(e.target.value)}>
                            {
