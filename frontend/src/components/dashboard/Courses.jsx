            ...
            <div className="row">
                <div className="col-12">
                    <div className="summary-title mb-5">
                        <h2 className="text-center">Semester</h2>
                    </div>
                </div>
            </div>
            <div className="row">
                            ...
                            (
                                user.courses.map(course => (
                                    <div className="accordion-item" key={course._id}>
                                        ...
                                        <div id={'collapse' + course._id} className="accordion-collapse collapse show" aria-labelledby={'heading' + course._id} data-bs-parent="#accordionExample">
